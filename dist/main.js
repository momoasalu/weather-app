...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,SAAS;EACT,iBAAiB;AACnB;;AAEA;;EAEE,SAAS;AACX;;AAEA;EACE,aAAa;EACb,UAAU;EACV,sBAAsB;EACtB,gCAAgC;EAChC,8BAA8B;AAChC;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,gCAAgC;AAClC;;AAEA;EACE,aAAa;EACb,qBAAqB;EACrB,qBAAqB;EACrB,SAAS;EACT,aAAa;AACf;;AAEA;EACE,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,qBAAqB;AACvB;;AAEA;EACE,aAAa;EACb,qCAAqC;EACrC,6BAA6B;EAC7B,mBAAmB;EACnB,qBAAqB;EACrB,qBAAqB;EACrB,6BAA6B;EAC7B,aAAa;EACb,kBAAkB;AACpB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,uBAAuB;EACvB,sBAAsB;EACtB,kBAAkB;EAClB,aAAa;EACb,uBAAuB;EACvB,qBAAqB;AACvB;;AAEA;EACE,mBAAmB;EACnB,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,wBAAwB;EACxB,oBAAoB;EACpB,6BAA6B;AAC/B;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,8BAA8B;EAC9B,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,kBAAkB;EAClB,iBAAiB;EACjB,uBAAuB;AACzB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,QAAQ;AACV;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;EACnB,QAAQ;EACR,eAAe;AACjB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,SAAS;EACT,kBAAkB;AACpB;;AAEA;EACE,WAAW;AACb;;AAEA;;EAEE,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,gCAAgC;EAChC,6BAA6B;EAC7B,YAAY;EACZ,kBAAkB;EAClB,sBAAsB;EACtB,uBAAuB;AACzB;;AAEA;EACE,gBAAgB;EAChB,kBAAkB;EAClB,aAAa;EACb,qBAAqB;AACvB;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,iBAAiB;EACjB,iBAAiB;EACjB,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,iBAAiB;EACjB,eAAe;AACjB;;AAEA;;EAEE,kBAAkB;EAClB,sBAAsB;AACxB;;AAEA;EACE,MAAM;AACR;;AAEA;EACE,SAAS;AACX","sourcesContent":["body {\n  margin: 0;\n  min-height: 100vh;\n}\n\nh5,\np {\n  margin: 0;\n}\n\nmain {\n  display: grid;\n  gap: 100px;\n  grid-auto-flow: column;\n  grid-template-columns: 1fr 350px;\n  min-height: calc(100vh - 19px);\n}\n\ndiv.current-info {\n  display: grid;\n  grid-auto-flow: column;\n  grid-template-columns: 500px 1fr;\n}\n\ndiv.current {\n  display: grid;\n  justify-items: center;\n  align-content: center;\n  gap: 15px;\n  padding: 20px;\n}\n\ndiv.current .city {\n  text-align: center;\n  font-size: 4rem;\n}\n\ndiv.current .current-time {\n  font-size: 1.25rem;\n}\n\ndiv.current img {\n  width: 250px;\n}\n\ndiv.current .condition {\n  text-align: center;\n  font-size: 2rem;\n}\n\ndiv.current .temp {\n  font-size: 3rem;\n}\n\ndiv.current div.current-weather {\n  display: grid;\n  justify-items: center;\n}\n\ndiv.extra {\n  display: grid;\n  grid-template-columns: auto auto auto;\n  grid-template-rows: auto auto;\n  align-items: center;\n  justify-items: center;\n  align-content: center;\n  justify-content: space-evenly;\n  row-gap: 50px;\n  text-align: center;\n}\n\ndiv.extra > div > div {\n  width: 100px;\n  height: 100px;\n  border: 1px solid black;\n  box-sizing: border-box;\n  border-radius: 50%;\n  display: grid;\n  justify-content: center;\n  align-content: center;\n}\n\ndiv.extra h5 {\n  margin-bottom: 10px;\n  font-size: 1rem;\n}\n\n.arrow {\n  position: absolute;\n  left: calc(100% - 7.5px);\n  top: calc(50% - 9px);\n  transform-origin: -42.5px 9px;\n}\n\ndiv.extra #feels-like {\n  font-size: 1.75rem;\n}\n\ndiv.extra #humidity {\n  font-size: 2rem;\n}\n\ndiv.extra #uv-index {\n  font-size: 2.5rem;\n}\n\ndiv.extra #wind {\n  position: relative;\n}\n\ndiv.extra #wind p.wind {\n  font-size: 1.5rem;\n}\n\ndiv.extra #precip {\n  font-size: 1.25rem;\n}\n\ndiv.extra #cloud {\n  font-size: 2rem;\n}\n\ndiv.slideshow {\n  position: relative;\n  padding: 20px 0;\n}\n\ndiv.slide {\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n  gap: 15px;\n}\n\ndiv.slide div.date {\n  text-align: center;\n  padding: 5px 20px;\n  border: 1px solid black;\n}\n\ndiv.slide div.date .day {\n  font-size: 2rem;\n}\n\ndiv.slide div.date .month {\n  font-size: 1rem;\n}\n\ndiv.sun-moon-info {\n  display: grid;\n  gap: 5px;\n}\n\ndiv.moon-phase {\n  display: grid;\n  grid-auto-flow: column;\n  justify-content: center;\n  align-items: center;\n  gap: 5px;\n  font-size: 1rem;\n}\n\ndiv.moon-phase img {\n  height: 20px;\n}\n\ndiv.sunrise-sunset {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 30px;\n  text-align: center;\n}\n\ndiv.sunrise-sunset img {\n  width: 60px;\n}\n\ndiv.sunrise > p,\ndiv.sunset > p {\n  font-size: 15px;\n}\n\ndiv.hour {\n  display: grid;\n  grid-template-columns: 150px 1fr;\n  grid-template-rows: auto auto;\n  width: 300px;\n  padding: 10px 20px;\n  box-sizing: border-box;\n  border: 1px solid black;\n}\n\ndiv.hour > .weather-condition {\n  grid-row: span 2;\n  text-align: center;\n  display: grid;\n  justify-items: center;\n}\n\ndiv.hour .icon {\n  width: 75px;\n}\n\ndiv.hour > .time {\n  align-self: start;\n  justify-self: end;\n  font-size: 50px;\n}\n\ndiv.hour > .temp {\n  align-self: center;\n  justify-self: end;\n  font-size: 30px;\n}\n\nbutton.prev,\nbutton.next {\n  position: absolute;\n  left: calc(50% - 20px);\n}\n\nbutton.prev {\n  top: 0;\n}\n\nbutton.next {\n  bottom: 0;\n}\n"],"sourceRoot":""}]);
// Exports
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/format/index.js");
...
/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./style.css */ "./src/style.css");
...
function populatePage(promise) {
  promise.then((data) => {
    ...
    time.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_27__["default"])(data.time, "EEE dd MMM yyyy HH:mm");
    ...
    slides.forEach((slide) => {
      ...
      day.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_27__["default"])(data.forecastday[i].date, "dd");
      const month = slide.querySelector(".month");
      month.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_27__["default"])(data.forecastday[i].date, "MMM");
